...
public class WebDriverHelper {
    ...
    private static final String WEBDRIVER_BINAARY = "webdriver.binaary";
    ...
    public static WebDriver getDriver() {
        ...
        if (driver == null) {
            ...
            options.setBinary(new FirefoxBinary(new File(PropertiesHelper.get(WEBDRIVER_BINAARY))));
            ...
            if (Boolean.parseBoolean(PropertiesHelper.get(WEBDRIVER_HEADLESS))) {
                // due to a weird bug, we actually have to set this option two different ways (at least we do on a Mac)
